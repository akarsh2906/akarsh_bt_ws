...
def generate_launch_description():
    ...
    world_file = LaunchConfiguration("world_file", default = join(diff_bot_path, 'worlds', 'simple.world'))
    ...
    spawn_diff_bot_node = IncludeLaunchDescription(
        PythonLaunchDescriptionSource(join(diff_bot_path, "launch", "diff_bot_gazebo_spawn.launch.py")),
    )
